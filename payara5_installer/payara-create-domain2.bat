...
call set ADMIN_PORT=4949
call set HTTP_PORT=8181
call set POSTFIX_PORT=82
call set DOMAIN_NAME=domain2
call set DB_NAME=pe-addon-v33
call set DB_USER=pe20
call set DB_PWD=jupiter
call set DB_HOST=172.19.114.114
call set DB_PORT=5432
